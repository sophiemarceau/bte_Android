...
//                c.drawBitmap(bitmap,src,dest,null);
                c.drawBitmap(bitmap, pointBuffer[0] - bitmap.getWidth() / 2, pointBuffer[1] - bitmap.getHeight() / 2, null);
            }else {//sar指标
                mRenderPaint.setColor(Color.parseColor("#2FD2B2"));
                c.drawCircle(pointBuffer[0], pointBuffer[1], shapeHalf*0.3f, mRenderPaint);
                mRenderPaint.setColor(Color.parseColor("#ffffff"));
                c.drawCircle(pointBuffer[0], pointBuffer[1], shapeHalf*0.2f, mRenderPaint);
            }
...
//
//
//            float innerShapeHalf = shapeHalf * 0.5f;
//
//            final int innerColor = Color.parseColor("#ccff0000");
//            mHighlightPaint.setColor(innerColor);
//            c.drawCircle(pointBuffer[0], pointBuffer[1], innerShapeHalf, mHighlightPaint);
        }
    }
...
//            c.drawCircle(pointBuffer[0], pointBuffer[1], shapeHalf, mHighlightPaint);
            ...
            mHighlightPaint.setColor(Color.parseColor("#19525866"));
