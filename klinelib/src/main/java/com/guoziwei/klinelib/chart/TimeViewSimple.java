...
public class TimeViewSimple extends BaseView implements CoupleChartGestureListener.InfoListener {
    ...
    public TimeViewSimple(Context context) {
        this(context, null);
    }

    public TimeViewSimple(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TimeViewSimple(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void showEma(){
        setEmaKlineByChart(mChartPrice);
        updateIndicators(-1);
    }
...
//        mChartPrice.setXMarker(mvx);
     ...
     * K线图初始化
     */
    public void initDataTime(List<KLineFullData> hisDatas) {
        addLast = false;
        removeAllViews();
        initUI(mContext);
        mData.clear();
...
//        mChartRsi.zoom(MAX_COUNT * 1f / INIT_COUNT, 0, 0, 0);
    ...
    public void setEmaKlineByChart(AppCombinedChart combinedChart) {
        mainIndicators = 1;
        ArrayList<Entry> priceEntries = new ArrayList<>(INIT_COUNT);
...
//        addLastRefrestExtraChart();
    ...
    private void setOffset() {
        ...
        mChartPrice.setViewPortOffsets(0, 0, rightPadding, 0);
    ...
    public void setKLineInfo(int dataIndex) {
        ...
        KLineFullData hisData = mData.get(dataIndex);
        KLineFullData PreHisdata = mData.get(dataIndex - 1);
