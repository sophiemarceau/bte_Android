...
public class TickChart extends RelativeLayout {
    ...
    private List<KLineFullData> mList = new ArrayList<>();
    ...
    public void addEntries(List<KLineFullData> list) {
        mList.clear();
        mList.addAll(list);
        ...
        for (int i = 0; i < mList.size(); i++) {
            KLineFullData hisData = mList.get(i);
    ...
    public void addEntry(KLineFullData hisData) {
