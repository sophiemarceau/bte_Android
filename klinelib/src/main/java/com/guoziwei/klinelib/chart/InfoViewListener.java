...
public class InfoViewListener implements OnChartValueSelectedListener {
    ...
    private List<KLineFullData> mList;
    ...
    public InfoViewListener(Context context, double lastClose, List<KLineFullData> list, ChartInfoView infoView) {
    ...
    public InfoViewListener(Context context, double lastClose, List<KLineFullData> list, ChartInfoView infoView, Chart... otherChart) {
        mWidth = DisplayUtils.getWidthHeight(context)[0];
        mLastClose = lastClose;
        mList = list;
        mInfoView = infoView;
