...
public class MoveViewJob extends ViewPortJob {
    ...
    public static MoveViewJob getInstance(ViewPortHandler viewPortHandler, float xValue, float yValue, Transformer trans, View v){
        ...
        result.mTrans = trans;
        result.viewReference = new WeakReference<>(v);
        return result;
    }
    ...
    public void run() {
        ...
        mViewPortHandler.centerViewPort(pts, viewReference.get());
    ...
    protected ObjectPool.Poolable instantiate() {
        return new MoveViewJob(mViewPortHandler, xValue, yValue, mTrans, viewReference.get());
    }
}
