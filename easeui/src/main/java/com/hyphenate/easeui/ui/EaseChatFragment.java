...
//        rl_kline_info = getView().findViewById(R.id.rl_kline_info);
//        rl_kline_chart = getView().findViewById(R.id.rl_kline_chart);
//        tv_kline_status_shouqi = getView().findViewById(R.id.tv_kline_status_shouqi);
//
//        tv_kline_status_xiala = getView().findViewById(R.id.tv_kline_status_xiala);
//        tv_kline_status_xiala.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                rl_kline_info.setVisibility(View.GONE);
//                rl_kline_chart.setVisibility(View.VISIBLE);
//            }
//        });
//
//        tv_kline_status_shouqi.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                rl_kline_info.setVisibility(View.VISIBLE);
//                rl_kline_chart.setVisibility(View.GONE);
//            }
//        });
            ...
            startActivityForResult(
                    new Intent(MediaStore.ACTION_IMAGE_CAPTURE).putExtra(MediaStore.EXTRA_OUTPUT,
                            FileProvider.getUriForFile(getContext(),
                                    "com.btetop.fileprovider", cameraFile)), REQUEST_CODE_CAMERA);
        } else {
            startActivityForResult(
                    new Intent(MediaStore.ACTION_IMAGE_CAPTURE).putExtra(MediaStore.EXTRA_OUTPUT,
