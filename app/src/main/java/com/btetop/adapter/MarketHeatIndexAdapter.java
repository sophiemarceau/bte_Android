...
public class MarketHeatIndexAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MarketHeatIndexAdapter(Activity mContext, List<MarketCoinPairBean.ListBean> list, ItemClick itemClick) {
    ...
    private void initHeaderLayout(HeadViewHolder holder, int pos) {
        ...
        holder.tvItemMarketHeadPrice.setText("价格/涨跌");
        holder.tvItemMarketHeadChange.setText("热度指数");
    }
}
