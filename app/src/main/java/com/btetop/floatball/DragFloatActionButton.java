...
public class DragFloatActionButton extends android.support.v7.widget.AppCompatButton {
    ...
    private void init() {
        ...
        statusHeight = Utils.getStatusHeight(getContext());
        virtualHeight=Utils.getVirtualBarHeigh(getContext());
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                //检测是否到达边缘 左上右下
                x = x < 0 ? 0 : x > screenWidth - getWidth()/2 ? screenWidth - getWidth() /2: x;
